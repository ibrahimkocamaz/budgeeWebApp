    ...
    const addBudget = async (newBudget) => {
        try {
            const budgetData = {
                ...
                amount: toCents(newBudget.amount),
            ...
            setBudgets(prev => [formattedBudget, ...prev]);
            return { data: formattedBudget, error: null };
        } catch (error) {
        ...
        try {
            const { data, error } = await supabase
                ...
                .update({
                    ...
                    amount: toCents(updatedBudget.amount),
            ...
            setBudgets(prev => prev.map(budget =>
                budget.id === updatedBudget.id ? formattedBudget : budget
            ));
            return { data: formattedBudget, error: null };
        } catch (error) {
